...
let dernier = 0; // Dernière citation affichée
let nombreAleatoire; // Nombre aléatoire pour la citation
...
const nouvelleCitation = document.getElementById("nouveau");
...
nouvelleCitation.addEventListener("click", handleClickCitation);
